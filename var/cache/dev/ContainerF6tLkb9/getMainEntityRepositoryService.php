 ...
 */
class getMainEntityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MainEntityRepository' shared autowired service.
     *
     * @return \App\Repository\MainEntityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MainEntityRepository.php';

        return $container->privates['App\\Repository\\MainEntityRepository'] = new \App\Repository\MainEntityRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
